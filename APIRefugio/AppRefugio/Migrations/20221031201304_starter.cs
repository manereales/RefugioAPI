    ...
    public partial class starter : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_veterinariosAnimales", x => new { x.VeterinarioId, x.AnimalesId });
                    table.ForeignKey(
                        name: "FK_veterinariosAnimales_Animales_AnimalesId",
                        column: x => x.AnimalesId,
                        principalTable: "Animales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_veterinariosAnimales_Veterinarios_VeterinarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_veterinariosAnimales_AnimalesId",
                table: "veterinariosAnimales",
                column: "AnimalesId");
        }
